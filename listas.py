...
#Programa principal
print("Reto #1: Analizar una cadena de caracteres")
...
print("Reto #2: El Gordito Navideño")
ESGorditoNavidenno()
print("")

print("Reto #3: Indicando la paridad")
print("Entrada: 5")
print("Salida: ")
print(ESIndicarParidad("5"))
print("")

print("Reto #4: Convirtiendo en listas")
